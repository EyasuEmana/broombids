...
$(document).on('click','#postrequirement',function(){
	...
	{
		$("#err").html('<div class="alert dark alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>Please Select From Date.</div>');
		$("#fromdate").focus();
		return false;
	}
	else if(todate == '')
	{
		$("#err").html('<div class="alert dark alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>Please Select To Date.</div>');
		$("#todate").focus();
		return false;
	}
	else if(todate < fromdate)
	{
		$("#err").html('<div class="alert dark alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>To date is before than From Date.</div>');
		$("#todate").focus();
		return false;
	}
	else
	{
		$.ajax({
	        ...
	        data: {"ptitle":ptitle,"pcartype":pcartype,"plocation":plocation,"fromdate":fromdate,"todate":todate,"rangrfrom":rangrfrom,"rangrto":rangrto,"remark":remark},
	        beforeSend: function () {
	        },
	        success: function (responce) {
	        	if(responce == 'success')
	        	{
	        		$("#err").html('<div class="alert dark alert-info alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>Your car booking request has been submitted successfully. Our vendor will start offering price.</div>');
		        		$("#ptitle").val('');
						$("#pcartype").val('');
						$("#pcarname").val('');
						$("#plocation").val('');
	        	...
	        	{
	        		$("#err").html('<div class="alert dark alert-warning alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button><a href="'+path+'Login">Click hire </a> To Login </div>');
	        	}
	        	else
	        	{
