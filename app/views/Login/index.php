  ...
  var startApp = function() {
    gapi.load('auth2', function(){
      ...
      auth2 = gapi.auth2.init({
        client_id: '169270268630-togak58q1gukpvujdc3g69akkut52kt6.apps.googleusercontent.com',
        cookiepolicy: 'single_host_origin',
        redirect_uri : 'https://localhost/broombids.com/'
                            ...
                            <div class="col-lg-6">                                
                                <div class="signin-from-inner" id="signin-from-inner">
                                    ...
                                    <form action="#" class="singn-form">
                                        ...
                                        <center><a href="javaScript:void(0);" class="pix-btn color-two wow pixFadeUp" data-wow-delay="0.3s" id="login_btn" style="visibility: visible; width: 100%;">Logine</a></center>
                                        <p style="margin-top: 40px;">Don’t have any account? <a href="<?=PROOT?>Customer">Sign up</a> now.</p>
                                        
                                    </form>
                                    <div class="col">        
                                        <a href="javaScript:void(0);" id="FB-login" class="twitter btn">Login with Facebook
                                         
                                        </a>

                                        <a href="<?php echo $google_client->createAuthUrl(); ?>" class="google btn" name="login-btn"> Login with Google+
                                        </a>
