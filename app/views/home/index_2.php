...
require_once(__DIR__ . '/../../../app/views/Login/google-login.php');
...
// // Accessing other properties if needed
// $id = $userInfo->id;
...
// echo "Verified Email: " . $verifiedEmail;
        ...
        <div class="banner-content-wrap">
			                ...
			                <div id="job_tab2" class="content">
			                    ...
			                    if($posts)
			                    {
			                        foreach ($posts as $post) 
			                        {
			                            ...
			                            ?>
				                        <div class="col-lg-4 col-md-7 col-sm-7" style="flex: 1; padding: 15px;">
				                            <div class="job job__color--one" style="display: flex;flex-direction: column;height: 100%; ">
				                                <div class="job__logo">
			                    ...
			                    <a href="<?=PROOT?>post" class="pix-btn color-two wow pixFadeUp" data-wow-delay="0.9s" style="visibility: visible; animation-delay: 0.5s; animation-name: i; margin-top: 25px; ">Discover More</a>
			                </div>
            ...
            <section class="newsletter" style="background: #2cc1d6; margin-top: 60px;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="newsletter-content"><h2 class="title wow pixFadeUp">Subscribe now to get company news.</h2></div>
                        </div>
                        <div class="col-lg-7">
